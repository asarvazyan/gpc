...
class Robot {
    ...
    loadBase() {
        const base = new THREE.Mesh(new THREE.CylinderGeometry(50, 50, 15, 32, 32), this.material);
    ...
    loadArm() {
        ...
        const armBase = new THREE.Mesh(new THREE.CylinderGeometry(20, 20, 18, 32, 32), this.material);
        const armTendon = new THREE.Mesh(new THREE.BoxGeometry(18, 120, 12, 32, 32), this.material);
        const armTop = new THREE.Mesh(new THREE.SphereGeometry(20, 32, 32), this.material);
    ...
    loadForearm() {
        ...
        const forearmBase = new THREE.Mesh(new THREE.CylinderGeometry(22, 22, 6, 32, 32), this.material);
        const forearmNerve1 = new THREE.Mesh(new THREE.BoxGeometry(4, 80, 4, 32, 32), this.material);
        const forearmNerve2 = new THREE.Mesh(new THREE.BoxGeometry(4, 80, 4, 32, 32), this.material);
        const forearmNerve3 = new THREE.Mesh(new THREE.BoxGeometry(4, 80, 4, 32, 32), this.material);
        const forearmNerve4 = new THREE.Mesh(new THREE.BoxGeometry(4, 80, 4, 32, 32), this.material);
        const forearmTop = new THREE.Mesh(new THREE.CylinderGeometry(15, 15, 40, 32, 32), this.material);
    ...
    loadClamp() {
        ...
        const clampBoxLeft  = new THREE.Mesh(new THREE.BoxGeometry(19, 20, 4, 3, 3), this.material);
        const clampBoxRight = new THREE.Mesh(new THREE.BoxGeometry(19, 20, 4, 3, 3), this.material);
        ...
        const clampTipLeft = new THREE.Mesh(clampTipGeometry, this.material);
        const clampTipRight = new THREE.Mesh(clampTipGeometry, this.material);
