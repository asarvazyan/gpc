...
function loadScene() {
    ...
    const baseMaterial = new THREE.MeshNormalMaterial({wireframe: is_wire, flatShading: is_flatshade});
    const armMaterial = new THREE.MeshNormalMaterial({wireframe: is_wire, flatShading: is_flatshade});
    const forearmMaterial = new THREE.MeshNormalMaterial({wireframe: is_wire, flatShading: is_flatshade});
    const clampMaterial = new THREE.MeshNormalMaterial({wireframe: is_wire, flatShading: is_flatshade});
    const clampTipMaterial = new THREE.MeshNormalMaterial({wireframe: is_wire, flatShading: is_flatshade});
